...
public class NashEquilibriumLP extends Strategy {
    ...
    public void setNashEquilibriumStrategy(int[][] M1, int[][] M2, String[] labelsP1, String[] labelsP2, PlayStrategy myStrategy) {
        ...
        b -= M2[1][1];
        double p = -b / a;
        System.out.printf("a: %f, b: %f, p: %f\n", a, b, p);
        myStrategy.put(labelsP1[0], p);
        myStrategy.put(labelsP1[1], 1 - p);

        double[] strategy = new double[2];
        strategy[0] = p;
        strategy[1] = 1 - p;
        this.showStrategy(1, strategy, labelsP1);
        ...
        p = -b / a;
        System.out.printf("a: %f, b: %f, p: %f\n", a, b, p);
        myStrategy.put(labelsP2[0], p);
        myStrategy.put(labelsP2[1], 1 - p);

        strategy = new double[2];
        strategy[0] = p;
        strategy[1] = 1 - p;
        this.showStrategy(2, strategy, labelsP2);
    }
